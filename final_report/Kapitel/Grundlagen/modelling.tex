...
In this chapter a multi body dynamic system model is used in the prediction step of EKF. Here, the robot is modelled as multi body dynamic system in which the motion of the robot is caused by application of torques at the respective joints.
