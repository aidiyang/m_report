...
In Figure \ref{fig:exp_idp}, $x_0$ and $\hat x_0$ represents the initial values of the states of the system and estimator. The input $\tau$ applied to the ankle joint of the system is represented by $u$. The system and estimator are initialzed with different initial values. $$ x_0 = \begin{bmatrix} x \\ x\\ x\\ x \end{bmatrix}, \hat x_0 = \begin{bmatrix} 0 \\ 0\\ 0\\ 0 \end{bmatrix}.$$ The experimental setup is simulated for 10 seconds with time step of 1 millisecond.
