...
$$ x_0 = \begin{bmatrix} x \\ x\\ x\\ x \end{bmatrix}, \hat x_0 = \begin{bmatrix} 0 \\ 0\\ 0\\ 0 \end{bmatrix}.$$  
...
\begin{figure}[H]
	\centering
	\includegraphics[trim = 0mm 0mm 0mm 0mm,scale=0.6]{Bilder/idp_ukf.png}
