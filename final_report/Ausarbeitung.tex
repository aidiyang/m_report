...
\newcommand\diag[4]{\multicolumn{1}{p{#2}|}{\hskip-\tabcolsep
...
\begin{titlepage}
 ...
 \includegraphics[scale=0.1]{Bilder/irf_logo} 
 \end{minipage}
 %\end{comment}
...
\begin{table} [H]
	...
	Examiners: & \\
	Prof. Dr.-Ing. Uwe Schwiegelshohn & Dipl.-Ing. Oliver Urbann\\
	&\\	
	Abteilung Informationstechnik\newline Institut f\"{u}r Roboterforschung  & Abteilung Informationstechnik\newline Institut f\"{u}r Roboterforschung\\
	\end{tabular}
	\end{table}		 
	\rmfamily
	\changefont{ppl}{m}{n}
 ...
 \end{titlepage}
    ...
    \changefont{ppl}{m}{n}
    \blankpage
    \input{Kapitel/acknowledgement.tex}
    \newpage
    \tableofcontents
    \cleardoublepage
	...
	%\input{testpage.tex}
    \input{Kapitel/Grundlagen/state_estimation.tex}
    \input{Kapitel/Grundlagen/kalman_filtering.tex}
    %\input{Kapitel/Grundlagen/dpendulum.tex}
    \input{Kapitel/Grundlagen/modelling.tex}
    \input{Kapitel/Grundlagen/simple_model.tex}
    ...
    \appendix
    \input{Kapitel/Zusammenfassung/appendix.tex}
	%\printindex
